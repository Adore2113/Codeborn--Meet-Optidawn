...
terminal_2 = pygame.image.load("CS4.2.png").convert_alpha()
terminal_2 = pygame.transform.smoothscale(terminal_2, (1000, 700))
terminal_3 = pygame.image.load("CS4.3.png").convert_alpha()
terminal_3 = pygame.transform.smoothscale(terminal_3, (1000, 700))
terminal_4 = pygame.image.load("CS4.4.png").convert_alpha()
terminal_4 = pygame.transform.smoothscale(terminal_4, (1000, 700))
terminal_type = pygame.image.load("ESC.png").convert_alpha()
...
def main():
    ...
    #--------------------question 4
            ...
            screen.blit(tf3, tf3_rect)
            tf4 = font_terminal.render(text4, True, cyan_soft)
            tf4_rect = tf4.get_rect(topleft=(100, 335))
            screen.blit(tf4, tf4_rect)
